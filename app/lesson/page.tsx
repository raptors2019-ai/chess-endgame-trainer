...
export default function LessonPage() {
  const trainer = useEndgameTrainer("lesson");
      ...
      <div className="flex-1 flex flex-col items-center px-4 sm:px-6 py-10 sm:py-12 max-w-4xl mx-auto">
        <div className="text-center mb-8">
          <h1 className="font-heading text-3xl font-bold tracking-tight mb-2">
            Learn an Endgame Pattern
          </h1>
          <p className="text-muted-foreground text-sm max-w-md mx-auto">
            Choose a pattern to learn. Your coach will walk you through the
      ...
      <div className="flex flex-col items-center gap-4 shrink-0 w-full lg:w-auto">
        ...
        <Card className="w-full max-w-[480px]" size="sm">
          <CardHeader className="pb-2">
            <CardTitle className="text-sm">Lesson Focus</CardTitle>
          </CardHeader>
          <CardContent className="space-y-3 text-xs">
            ...
            <Separator />
            <div>
              <p className="font-medium text-foreground">Main plan</p>
              <p className="mt-1 text-muted-foreground">
        ...
        <div className="flex gap-2 flex-wrap justify-center">
          <Button variant="outline" size="sm" onClick={handleNextPosition}>
            {trainer.isGameOver ? "Next Position" : "New Position"}
          </Button>
          <Button
            variant="outline"
            size="sm"
